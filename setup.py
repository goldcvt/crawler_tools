...
setup(
    ...
    version='0.2.2.1',      # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/goldcvt/archive/crawler_tools/v_0.2.2.1.tar.gz',    # I explain this later on
